...
public class CurlUtils {
    ...
    public synchronized static String getCAPath(){
    ...
    private static boolean copyCAFromAssetsToPath(String path) {
        if (path == null){
            return false;
        }
    ...
    public static boolean saveDataToPath(byte[] data, String path) {
        if (path == null) {
            return false;
        }
        boolean ret = true;
